...
import com.mego.myapplication.util.Constants.Companion.QUERY_PAGE_SIZE
import com.mego.myapplication.util.Resource
import kotlinx.android.synthetic.main.fragment_news.*
import kotlinx.android.synthetic.main.news_item.*

/*fragment to show articles from api*/
...
class NewsFragment : Fragment(R.layout.fragment_news) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
       ...
       viewModel.topStories.observe(viewLifecycleOwner, Observer { response ->
            when(response) {
                is Resource.Success -> {
                    hideProgressBar()
                    response.data?.let { newsResponse ->
                        ...
                        isLastPage = viewModel.topStoriesPage == totalPages
                    }
                }
                is Resource.Error -> {
                    hideProgressBar()
